...
namespace PJATK_APBD_Cw4_s29756.Migrations
{
    ...
    [Migration("20260525151053_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s29756.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s29756.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s29756.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s29756.Models.Pc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s29756.Models.PcComponent", b =>
                {
                    b.Property<int>("PcId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s29756.Models.Component", b =>
                {
                    b.HasOne("PJATK_APBD_Cw4_s29756.Models.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PJATK_APBD_Cw4_s29756.Models.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s29756.Models.PcComponent", b =>
                {
                    b.HasOne("PJATK_APBD_Cw4_s29756.Models.Component", "Component")
                        .WithMany("PcComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PJATK_APBD_Cw4_s29756.Models.Pc", "Pc")
                        .WithMany("PcComponents")
                        .HasForeignKey("PcId")
